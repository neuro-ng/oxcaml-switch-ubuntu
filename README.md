...
[![Build and Publish OxCaml Docker Image](https://github.com/neuro-ng/oxcaml-switch-ubuntu/actions/workflows/docker-publish.yml/badge.svg)](https://github.com/neuro-ng/oxcaml-switch-ubuntu/actions/workflows/docker-publish.yml)
...
* **Base**: Ubuntu 25.04 with opam
* **Compiler**: OxCaml 5.2.0+ox (based on OCaml 5.2.0)
* **Repository**: ox opam repository configured

### What's NOT Included

This minimal image does NOT include development tools like:
* dune, utop, ocaml-lsp-server, merlin, ocamlformat
* Additional libraries beyond the compiler
...
# Run interactively
docker run -it --rm ghcr.io/neuro-ng/oxcaml-ubuntu:latest

# Mount your project directory
docker run -it --rm -v $(pwd):/workspace ghcr.io/neuro-ng/oxcaml-ubuntu:latest
```
